...
# Really need to figure out if I should upstream the patch...
http_archive(
    name = "com_github_google_flatbuffers",
    patch_args = ["-p1"],
    patches = ["//:build/flatbuffers.patch"],
    sha256 = "fa0036f4a2d082f7034fd90a53a02ce0e121548b39c07c8d2a77a821da02fb01",
    strip_prefix = "flatbuffers-23.5.9",
    url = "https://github.com/google/flatbuffers/archive/refs/tags/v23.5.9.tar.gz",
)

# The below are just copied from flatbuffer's WORKSPACE file, since I couldn't
# be bothered to update things to bzlmod.
...
http_archive(
    ...
    patch_args = ["-p1"],
    patches = ["@com_github_google_flatbuffers//grpc:build_grpc_with_cxx14.patch"],
