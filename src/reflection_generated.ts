...
// @ts-ignore
import {BaseType as reflectionBaseType, Enum as reflectionEnum, EnumT as reflectionEnumT, EnumVal as reflectionEnumVal, EnumValT as reflectionEnumValT, Field as reflectionField, FieldT as reflectionFieldT, KeyValue as reflectionKeyValue, KeyValueT as reflectionKeyValueT, Object_ as reflectionObject, ObjectT as reflectionObjectT, RPCCall as reflectionRPCCall, RPCCallT as reflectionRPCCallT, Schema as reflectionSchema, SchemaFile as reflectionSchemaFile, SchemaFileT as reflectionSchemaFileT, SchemaT as reflectionSchemaT, Service as reflectionService, ServiceT as reflectionServiceT, Type as reflectionType, TypeT as reflectionTypeT} from  './reflection_generated';
...
mutate_base_type(value:reflectionBaseType):boolean {
  const offset = this.bb!.__offset(this.bb_pos, 4);
...
mutate_element(value:reflectionBaseType):boolean {
  const offset = this.bb!.__offset(this.bb_pos, 6);
...
static addBaseType(builder:flatbuffers.Builder, baseType:reflectionBaseType) {
  builder.addFieldInt8(0, baseType, reflectionBaseType.None);
}

static addElement(builder:flatbuffers.Builder, element:reflectionBaseType) {
...
static createType(builder:flatbuffers.Builder, baseType:reflectionBaseType, element:reflectionBaseType, index:number, fixedLength:number, baseSize:number, elementSize:number):flatbuffers.Offset {
...
export class TypeT {
constructor(
  public baseType: reflectionBaseType = reflectionBaseType.None,
  public element: reflectionBaseType = reflectionBaseType.None,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return reflectionType.createType(builder,
    this.baseType,
    this.element,
    this.index,
    this.fixedLength,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return reflectionKeyValue.createKeyValue(builder,
    key,
    value
  );
}
...
unionType(obj?:reflectionType):reflectionType|null {
  const offset = this.bb!.__offset(this.bb_pos, 10);
...
constructor(
  ...
  public unionType: reflectionTypeT|null = null,
...
values(index: number, obj?:reflectionEnumVal):reflectionEnumVal|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
...
underlyingType(obj?:reflectionType):reflectionType|null {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? (obj || new reflectionType()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

attributes(index: number, obj?:reflectionKeyValue):reflectionKeyValue|null {
  const offset = this.bb!.__offset(this.bb_pos, 12);
...
constructor(
  ...
  public underlyingType: reflectionTypeT|null = null,
...
type(obj?:reflectionType):reflectionType|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new reflectionType()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
...
constructor(
  public name: string|Uint8Array|null = null,
  public type: reflectionTypeT|null = null,
  public id: number = 0,
...
fields(index: number, obj?:reflectionField):reflectionField|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return reflectionObject.createObject(builder,
    name,
    fields,
    this.isStruct,
    this.minalign,
...
request(obj?:reflectionObject):reflectionObject|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new reflectionObject()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

response(obj?:reflectionObject):reflectionObject|null {
  const offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new reflectionObject()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
...
constructor(
  public name: string|Uint8Array|null = null,
  public request: reflectionObjectT|null = null,
  public response: reflectionObjectT|null = null,
  public attributes: (KeyValueT)[] = [],
  public documentation: (string)[] = []
){}
...
calls(index: number, obj?:reflectionRPCCall):reflectionRPCCall|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return reflectionService.createService(builder,
    name,
    calls,
    attributes,
    documentation,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return reflectionSchemaFile.createSchemaFile(builder,
    filename,
    includedFilenames
  );
}
...
objects(index: number, obj?:reflectionObject):reflectionObject|null {
  const offset = this.bb!.__offset(this.bb_pos, 4);
...
enums(index: number, obj?:reflectionEnum):reflectionEnum|null {
  const offset = this.bb!.__offset(this.bb_pos, 6);
...
rootTable(obj?:reflectionObject):reflectionObject|null {
  const offset = this.bb!.__offset(this.bb_pos, 12);
  return offset ? (obj || new reflectionObject()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}

services(index: number, obj?:reflectionService):reflectionService|null {
  const offset = this.bb!.__offset(this.bb_pos, 14);
 ...
 * flatc was invoked.
 */
fbsFiles(index: number, obj?:reflectionSchemaFile):reflectionSchemaFile|null {
  const offset = this.bb!.__offset(this.bb_pos, 18);
...
constructor(
  ...
  public rootTable: reflectionObjectT|null = null,
