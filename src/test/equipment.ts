...
export function unionToEquipment(
  ...
  switch (Equipment[type]) {
    case "NONE":
      return null;
    case "Sword":
      return accessor(new Sword())! as Sword;
    case "Shield":
      return accessor(new Shield())! as Shield;
    default:
      return null;
  }
}
...
export function unionListToEquipment(
  ...
  switch (Equipment[type]) {
    case "NONE":
      return null;
    case "Sword":
      return accessor(index, new Sword())! as Sword;
    case "Shield":
      return accessor(index, new Shield())! as Shield;
    default:
      return null;
  }
}
